...
public partial class MessageDialog : Window
{
    ...
    internal static void Show(string message, string? title = null, DialogKind kind = DialogKind.Information, Window? owner = null)
    ...
    internal static bool Confirm(string message, string? title = null, Window? owner = null)
    {
